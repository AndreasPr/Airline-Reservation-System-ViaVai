...
echo "<form action='homepage_boarding_pass_oneway.php' method='POST'>";
...
if(isset($_POST['finish_button']))
{
  ...
  {
    echo "<script>if(confirm('ERROR!Could not able to execute your request.Try again!')){document.location.href='homepage_boarding_pass_oneway.php'};</script>";    
  }
