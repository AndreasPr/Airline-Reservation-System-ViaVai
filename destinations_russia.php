...
<html>
<head>
	<title>Destination Russia</title>
...
<div class="box">
<img src="images/destination_russia.jpg" id="events" alt="Events" width="100%"/>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="destinations_russia.jpg" alt="hotel1_russia">
        <h5 class="card-title">Special title treatment</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <p>lalalallala</p>
        <div class="row">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="destinations_russia.jpg" alt="hotel1_austria">
        <h5 class="card-title">Special title treatment</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
