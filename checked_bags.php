...
<br>
    ...
    <form id="contact-form" method="POST" action="checked_bags.php" role="form">
        ...
        <button id="confirm" name="confirm" class="btn btn-primary" style="margin-left: 90%;">Confirm</button>
          ...
          global $sql;
            $sql = "INSERT INTO check_baggage (check_baggage) VALUES ('$select_bag_option')";
              ...
              echo "<br><br>";
                echo "<div class='input-group' style = 'position: relative; left: 30%;  width: 40%;'>
                       <div class='input-group-prepend'>
                         <a href = 'seat_booking.php' style = 'text-decoration: none;' name = 'continue'>
