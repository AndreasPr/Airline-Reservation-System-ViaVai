...
<div class="box">
<img src="images/countries/spain.jpg" id="events" alt="Events" width="100%"/>
...
<h4 style="margin-left: 40%;">Popular hotels in Spain</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_spain_1_costaAdeje.jpg" alt="hotels">
        <h5 class="card-title">Costa Adeje</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_spain_2_kempinskiMarbella.jpg" alt="hotels">
        <h5 class="card-title">Kempinski Marbella</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_spain_3_laTorreDelCanonigo.jpg" alt="hotels">
        <h5 class="card-title">La Torre Del Canonigo</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_spain_4_hotelMajestic.jpg" alt="hotels">
...
<h4 style="margin-left: 40%;">Popular things to do in Spain</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_spain_1.jpg" alt="activities">
        <h5 class="card-title">Explore the Aquarium of Barcelona</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_spain_2.jpeg" alt="activities">
        <h5 class="card-title">Visit Sagrada Familia</h5>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_spain_3.jpg" alt="activities">
        <h5 class="card-title">Do not miss the magical coast of...Malagueta!</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_spain_4.jpg" alt="activities">
        <h5 class="card-title">Why not pass by...an astonishing waterfall?!</h5>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 80%; margin-left: 10%;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/other_spain_1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_spain_2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_spain_3.jpg" alt="Third slide">
    </div>
  </div>
...
<h4 style="margin-left: 40%;">Popular restaurants in Spain</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_spain_1_arola.jpg" alt="restaurants">
        <h5 class="card-title">Arola</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
<img class="card-img-top" src="images/restaurant_spain_2_michelinstar.jpg" alt="restaurants">        <h5 class="card-title">Michelin Star</h5>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
<img class="card-img-top" src="images/restaurant_spain_3_hispanialondon.jpg" alt="restaurants">        <h5 class="card-title">Hispania London</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
<img class="card-img-top" src="images/restaurant_spain_4_elOlivoMalllorca.jpg" alt="restaurants">        <h5 class="card-title">El Olivo - Mallorca</h5>
