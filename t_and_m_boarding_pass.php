...
if(isset($_SESSION["trips_and_more_booking_id"]))
{
  ...
  $airline_company = $_SESSION["airline_company"];
        ...
        <div class="card_seating">
            ...
            <div class="seating_seat">
                ...
                <h3>
                  ...
                  $sql2 = mysqli_query($con,'SELECT t_and_m_seat_booking_check
                  FROM  t_and_m_seat_booking
                  WHERE t_and_m_seat_booking_check = "$techno" ') or die(mysqli_error($con));
...
echo "<a href='trips_and_more.php'><button type='button' id = 'finish_button' style='background-color: #000066;' class='btn btn-primary'>Finish</button></a>";
?>
<br>
<br>
