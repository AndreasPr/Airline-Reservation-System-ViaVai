...
<br>
    ...
    <form id="contact-form" method="POST" action="t_and_m_checked_bags.php" role="form">
        ...
        <div class="controls">
            <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  $trips_and_more_booking_id = $_SESSION['trips_and_more_booking_id'];

                  $sql2 = mysqli_query($con,'SELECT trips_and_more_booking_id, price
                  FROM  trips_and_more_booking
                  WHERE price = "$price" AND trips_and_more_booking_id = "$trips_and_more_booking_id" ') or die(mysqli_error($con));
        ...
        <button id="confirm" name="confirm" class="btn btn-primary" style="margin-left: 90%;">Confirm</button>
          ...
          global $sql;
            $sql = "INSERT INTO t_and_m_check_baggage (t_and_m_check_baggage) VALUES ('$select_bag_option')";
              ...
              echo "<br><br>";
                echo "<div class='input-group' style = 'position: relative; left: 30%;  width: 40%;'>
                       <div class='input-group-prepend'>
                         <a href = 't_and_m_seat_booking.php' style = 'text-decoration: none;' name = 'continue'>
