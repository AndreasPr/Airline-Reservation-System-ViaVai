...
<br>
<br>
<form method="POST" action="t_and_m_congratulations.php">
...
{ 
  ...
  global $sql;
  $sql = "INSERT INTO t_and_m_check_in (check_in_number) VALUES ('$booking_reference_number')";
  ...
  if(mysqli_query($con, $sql))
  {
    ...
    echo "<div class='input-group' style = 'position: relative; left: 30%;  width: 40%;'>
             <div class='input-group-prepend'>
               <a href = 't_and_m_check_in.php' style = 'text-decoration: none;' name = 'continue'>
