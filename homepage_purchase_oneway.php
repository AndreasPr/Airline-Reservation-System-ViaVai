...
<form action="homepage_purchase_oneway.php" method="POST">
  ...
  if(mysqli_query($con, $sql))
  {
    echo "<br><br>";
      echo "<div class='input-group' style = 'position: relative; left: 30%;  width: 40%;'>
             <div class='input-group-prepend'>
               <a href = 'homepage_congratulations_oneway.php' style = 'text-decoration: none;' name = 'continue'>
