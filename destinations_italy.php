...
<div class="box">
<img src="images/destination_italy.jpg" id="events" alt="Events" width="100%"/>
...
<h4 style="margin-left: 40%;">Popular hotels in Italy</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_italy_1_grand_hotel_tremezzo_lake_como.jpg" alt="hotel1_italy">
        <h5 class="card-title">Grand Hotel Tremezzo- Lake Lomo</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_italy_2_stregisluxuryhotelflorence.jpg" alt="hotel2_italy">
        <h5 class="card-title">Stregis Luxury Hotel - Florence</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_italy_3_belmond_hotel_cipriani_venice.jpg" alt="hotel3_italy">
        <h5 class="card-title">Belmond Hotel Cipriani - Venice</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_italy_4_westinPalaceMilano.jpg" alt="hotel4_italy">
          <h5 class="card-title">Westin Palace - Milano</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<h4 style="margin-left: 40%;">Popular things to do in Italy</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_italy_1.jpg" alt="activities">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_italy_2.webp" alt="activities">
        <h5 class="card-title">Take a traditional Vespa ride!</h5>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_italy_3.jpg" alt="activities">
        <h5 class="card-title">Go Cycling around the beautiful cities!</h5>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_italy_4.jpg" alt="activities">
        <h5 class="card-title">Do not miss the famous carnival of Venice!</h5>
      </div>
    </div>
  </div>
</div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 80%; margin-left: 10%;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/other_italy_1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_italy_2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_italy_3.jpeg" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_italy_4.jpg" alt="Third slide">
    </div>
  </div>
...
<h4 style="margin-left: 40%;">Popular restaurants in Italy</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_italy_1_theenchantedgrotto.jpg" alt="restaurants">
        <h5 class="card-title">The Enchanted Grotto</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_italy_2_Caesar-Augustus-Capri.jpg" alt="restaurants">
         <h5 class="card-title">Caesar Augustus - Capri</h5>
    </div>
  </div>
</div></div>
<br>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_italy_3_Grand-Hotel-Villa-Serbelloni.jpg" alt="restaurants">
        <h5 class="card-title">Grand Hotel Villa Serbelloni</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_italy_4_Belmond-Villa-San-Michele.jpg" alt="restaurants">
        <h5 class="card-title">Belmod Villa San Michele</h5>
