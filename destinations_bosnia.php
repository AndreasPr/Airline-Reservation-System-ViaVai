...
<div class="box">
<img src="destinations_austria.jpg" id="events" alt="Events" width="100%"/>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="destinations_austria.jpg" alt="hotel1_austria">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 80%; margin-left: 10%;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="destinations_austria.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="destinations_austria.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="destinations_austria.jpg" alt="Third slide">
    </div>
  </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <h5>Explore!</h5>
                        <ul>
                            ...
                            <li><a href="trips_and_more.html">Trips & More</a></li>
                        </ul>
                </div>
                ...
                <div class="col-sm-3">
                    <h5>Join Us</h5>
                        <ul>
                            <li><a href="collaborate.html">to Collaborate</a></li>
                            <li><a href="member_club.html">ViaVai Member Club</a></li>
                            <li><a href="join our member club - login.html">Join our Member Club</a></li>
                            <li><a href="events.html">ViaVai Events</a></li>
                        </ul>
                </div>
                ...
                <div class="col-sm-3">
                        ...
                        <ul>
                            <li><a href="about.html">About ViaVai</a></li>
                            <li><a href="terms.html">Terms of Use & Conditions</a></li>
                ...
                <div class="col-sm-3">
                        ...
                        <ul>
                            ...
                            <li><a href="help.html">Ask for Help</a></li>
            ...
            <iframe id="map-container" frameborder="0" style="border:0"
                    src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJOwg_06VPwokRYv534QaPC8g&key=AIzaSyDMbxjzeP7UBy7aztWNxWPIC82TbVQsTfY" >
            </iframe>
        </div>
