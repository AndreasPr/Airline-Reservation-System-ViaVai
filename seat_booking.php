...
<form action="seat_booking.php" method="POST">
...
<a href="purchase.php"><button class="button" name="Confirm" id="Confirm">Confirm</button></a>
...
{ 
  ...
  {
    $query = "INSERT INTO seat_booking (seat_booking_check) VALUES ('".$checkbox1[$i]."')";
    ...
    echo "<br><br>";
      echo "<div class='input-group' style = 'position: relative; left: 20%;  width: 50%;'>
             <div class='input-group-prepend'>
               <a href = 'purchase.php' style = 'text-decoration: none;' name = 'purchase'>
