    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="on" action="homepage_contact_details_one_way.php" method="POST">
...
$formatteddate = $Date_Of_Birth->format('Y-m-d');
  ...
  global $sql;
  $sql = "INSERT INTO contact_details_booking_oneway (firstname, lastname, email, date_of_birth, gender, username, password, confirm_password) VALUES ('$firstname', '$lastname', '$email', '$formatteddate', '$gender', '$username', '$password', '$confirm_password')";
    ...
    echo "<br><br>";
      echo "<div class='input-group' style = 'position: relative; left: 30%;  width: 40%;'>
             <div class='input-group-prepend'>
               <a href = 'homepage_checked_bags_oneway.php' style = 'text-decoration: none;' name = 'continue'>
