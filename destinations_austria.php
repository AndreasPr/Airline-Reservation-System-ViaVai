...
<html>
<head>
	<title>Destination Austria</title>
...
<div class="box">
<img src="images/destinations_austria.jpg" id="events" alt="Events" width="100%"/>
 <div class="text-block">
	<h1>Austria - Vienna</h1>
 </div>
  <div class="shade"></div>
</div>
<br>
...
<h4 style="margin-left: 40%;">Popular hotels in Vienna</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_vienna1.jpg" alt="hotel1_austria">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_vienna2.jpg" alt="hotel1_austria">
        <h5 class="card-title">Hansen Hotel</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_vienna3.jpg" alt="hotel1_austria">
        <h5 class="card-title">Enziana Hotel</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_vienna4.jpg" alt="hotel1_austria">
        <h5 class="card-title">Rainers Hotel</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<h4 style="margin-left: 40%;">Popular things to do in Vienna</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_vienna1.jpg" alt="hotel1_austria">
        <h5 class="card-title">Spanish Riding School</h5>
        <p class="card-text" style="color: grey;">Duration: 20min</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_vienna2.jpg" alt="hotel1_austria">
        <h5 class="card-title">Discounts and public Transport</h5>
        <p class="card-text" style="color: grey;">Duration: 24hours</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_vienna3.jpg" alt="hotel1_austria">
        <h5 class="card-title">Mozart Concert</h5>
        <p class="card-text" style="color: grey;">Duration: 2hours</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_vienna4.jpg" alt="hotel1_austria">
        <h5 class="card-title">Walking Tour</h5>
        <p class="card-text" style="color: grey;">Duration: 2hours</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 80%; margin-left: 10%;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/photo_vienna1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/photo_vienna2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/photo_vienna3.jpg" alt="Third slide">
    </div>
  </div>
...
<h4 style="margin-left: 40%;">Popular restaurants in Vienna</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_vienna1.jpg" alt="hotel1_austria">
        <h5 class="card-title">Hilton restaurant</h5>
        <p class="card-text" style="color: grey;">At Hilton, We Love Having You Here.</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_vienna2.jpg" alt="hotel1_austria">
        <h5 class="card-title">Restaurant Weinbar</h5>
        <p class="card-text" style="color: grey;">At The Heart Of Lowcountry Style, Culture and Cuisine.</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_vienna3.jpg" alt="hotel1_austria">
        <h5 class="card-title">Sakai restaurant</h5>
        <p class="card-text" style="color: grey;">1080 Wein</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_vienna4.jpg" alt="hotel1_austria">
        <h5 class="card-title">Pichlmaiers zum Herkner</h5>
        <p class="card-text" style="color: grey;">1020 Wein</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
          </div>
