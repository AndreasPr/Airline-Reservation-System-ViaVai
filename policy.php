...
<div id = "logia_kai_eikona">
<h2>Security-Privacy Policy</h2>
<br>

<image src="images/privacy_policy.jpg" id = "policy_pic" alt="sign" width = "100%" height = "40%" />
<br>
<br>
<p>
ViaVai® in collaboration with <b>Symantec Corporation</b>, aims on the security of your personal data. The application is certified and based on international standards which allow a safe registration of your personal data. 
</p>
<p>
Symantec Corporation, having ensured the entire necessary infrastructure, provides completed services of certification and safety, based on advanced encoding technologies. Your personal data are automatically encoded for their guarantee and can only be disclosed by ViaVai®. 
</p>
<p>
Your name, email, address, telephone number or/and your credit card number are indispensable in order to proceed to your reservation. Your credit card details are not stored in our database. During the transaction all the security protocols are enabled. When you complete a reservation, your data are registered, stored and maintained through ViaVai®. The information is used exclusively for the facilitation of the reservation procedure, as well as for management reasons. Your data are never transmitted to third parties apart from the collaborating companies which you have selected to complete your reservations with and run any of your commands. Any newsletter or sms you receive has followed your consent and you have the possibility to declare any time, that you do not wish to receive any kind of offers or services. 
</p>
<p>
All the financial transactions and credit card debits are managed by ViaVai® Tourist Services S.A which resides in Kifissias Ave. 30-32, 15125 Amarousion, Athens, Greece and which edits all the legally descriptive.
</p>
</div>
