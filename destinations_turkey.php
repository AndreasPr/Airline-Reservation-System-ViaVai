...
<div class="box">
<img src="images/destination_turkey.jpg" id="events" alt="Events" width="100%"/>
...
<h4 style="margin-left: 40%;">Popular hotels in Turkey</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_turkey_1_lunaBlancaResortAntalya.jpg" alt="hotels">
        <h5 class="card-title">Luna Blanca Resort - Antalya</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_turkey_2_royalHolidayPalace.jpg" alt="hotels">
        <h5 class="card-title">Royal Holiday Palace</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_turkey_3_gamirasu_kapadokia.jpg" alt="hotels">
        <h5 class="card-title">Garamisu - Kapadokia</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/hotel_turkey_4_fameResidenceKemerHotel.jpg" alt="hotels">
        <h5 class="card-title">Fame Residence Kemer Hotel</h5>
        <p class="card-text" style="color: grey;">Hotel class: 4</p>
        <div class="row">
          <div class="col-sm-6">
            <button type="button" class="btn btn-light">Luxury</button>
...
<h4 style="margin-left: 40%;">Popular things to do in Turkey</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_turkey_1.jpg" alt="activities">
        <h5 class="card-title">WindSurf</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_turkey_2.jpg" alt="activities">
        <h5 class="card-title">Visit Aya Sofia in Istanbul</h5>
        <p class="card-text" style="color: grey;">Go for it!</p>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_turkey_3.jpg" alt="activities">
        <h5 class="card-title">Travel to another time...in Kapadokya</h5>
        <p class="card-text" style="color: grey;">Go for it!</p>
      </div>
    </div>
  </div>
 ...
 <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/things_turkey_4.jpg" alt="activities">
        <h5 class="card-title">Extreme Sports!</h5>
        <p class="card-text" style="color: grey;">Go for it!</p>
      </div>
    </div>
  </div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 80%; margin-left: 10%;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/other_turkey_1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_turkey_2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/other_turkey_3.jpg" alt="Third slide">
    </div>
  </div>
...
<h4 style="margin-left: 40%;">Popular restaurants in Turkey</h4>
<br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_turkey_1_saraydan.jpg" alt="restaurants">
        <h5 class="card-title">Saraydan</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_turkey_2_dolmabahce.jpg" alt="restaurants">
        <h5 class="card-title">Dolmabahçe</h5>
...
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_turkey_3_petek.jpg" alt="restaurants">
        <h5 class="card-title">Petek</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
          <img class="card-img-top" src="images/restaurant_turkey_4_istanbouli.jpg" alt="restaurants">
        <h5 class="card-title">Istanbouli</h5>
